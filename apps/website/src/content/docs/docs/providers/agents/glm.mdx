...
For container execution, [AML Agent Sandbox](/docs/providers/sandboxes/images/#aml-agent-sandbox) includes this adapter
baseline and is the default image for Docker, Daytona, and Modal. Local Sandbox still requires `glm-acp-agent` on the
host.
