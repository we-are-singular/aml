...
The [Copilot image variant](/docs/sandbox-images/#choose-a-variant) includes this pinned baseline. The default full image includes it too. Local Sandbox still requires Copilot CLI on the host.
