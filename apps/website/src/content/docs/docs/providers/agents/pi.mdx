...
The AML repository currently exercises `pi-acp@0.0.33`, `@earendil-works/pi-coding-agent@0.84.2`, and `pi-mcp-adapter@2.26.x`. Treat that set as a reproducible verification baseline, not an open-ended compatibility promise.
