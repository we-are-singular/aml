...
For container execution, [AML Agent Sandbox](/docs/providers/sandboxes/images/#aml-agent-sandbox) includes this Codex and
`codex-acp` baseline and is the default image for Docker, Daytona, and Modal. Local Sandbox still requires both commands
on the host.
