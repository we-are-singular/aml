...
For container execution, the [Codex image variant](/docs/sandbox-images/#choose-a-variant) includes this Codex and `codex-acp` baseline. The default full image includes them too. Local Sandbox still requires both commands on the host.
