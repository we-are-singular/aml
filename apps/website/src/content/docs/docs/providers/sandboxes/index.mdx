...
Need a concrete starting point? [Recommended Sandbox images](./images/) tracks public images we have inspected, upstream image recipes, exact Agent requirements, and combinations we deliberately do not claim are ready.
...
- [Agent and Sandbox compatibility](../../compatibility/)
