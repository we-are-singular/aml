...
See [AML Agent Sandbox images](/docs/sandbox-images/) for the full and single-Agent variants, Docker Hub and GHCR channels, pinning, and extension guidance. See [alternative and custom images](/docs/providers/sandboxes/images/) when replacing AML's image.
