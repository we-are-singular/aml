...
[`<File />`](/docs/reference/primitives/file/) writes through the nearest active [`<Workspace />`](/docs/reference/primitives/workspace/) or [`<Sandbox />`](/docs/reference/primitives/sandbox/) filesystem. [`<Script />`](/docs/reference/primitives/script/) can run directly on the trusted host, but this example deliberately uses a fresh Workspace directory and scopes command execution to that materialization.
