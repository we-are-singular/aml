...
```sh
npm install --global pi-acp@0.0.33 @earendil-works/pi-coding-agent@0.82.1
pi --version
command -v pi-acp
export OPENAI_API_KEY="your-development-key"
npm run aml
