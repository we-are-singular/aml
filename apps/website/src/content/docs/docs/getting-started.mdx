...
[`<File />`](/docs/reference/primitives/file/) requires [`<Workspace />`](/docs/reference/primitives/workspace/), and [`<Script />`](/docs/reference/primitives/script/) requires [`<Sandbox />`](/docs/reference/primitives/sandbox/). This example creates a fresh temporary directory so it cannot overwrite your repository.
