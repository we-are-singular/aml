...
| `cwd`               | `process.cwd()` | runtime    | Base directory for local [`<Skill />`](/docs/reference/primitives/skill/) files, unsandboxed [`<Script />`](/docs/reference/primitives/script/) execution, and its relative cwd overrides |
