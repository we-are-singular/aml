...
| `cwd`               | `process.cwd()` | runtime    | Base directory for local [`<Include src>`](/docs/reference/primitives/include/), [`<File src>`](/docs/reference/primitives/file/), and [`<Skill src>`](/docs/reference/primitives/skill/) reads plus unsandboxed [`<Script />`](/docs/reference/primitives/script/) execution and its relative cwd overrides |
