...
| `cwd`               | `process.cwd()` | runtime    | Base directory for local [`<Skill />`](/docs/reference/primitives/skill/) files and unsandboxed [`<Script />`](/docs/reference/primitives/script/) execution |
