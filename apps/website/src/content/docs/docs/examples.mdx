...
:::tip[Start with a useful workflow]
Run `review` for parallel specialists and synthesis, or `structured` for schema-validated output. Both default to deterministic providers and need no credentials.
:::
