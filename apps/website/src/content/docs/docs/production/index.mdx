...
| You need to…                                                 | Read                                                                                             |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |
| establish a threat model and protect credentials             | [Security](./security/)                                                                          |
| package AML into a service, worker, or job                   | [Deployment](./deployment/)                                                                      |
| operate retries, cancellation, locks, and traces             | [Operations](./operations/)                                                                      |
| diagnose a live cleanup, lock, publication, or trace failure | [Incident response](./incident-response/)                                                        |
| understand the provider-specific trade-offs                  | [Sandbox providers](../providers/sandboxes/) and [Workspace providers](../providers/workspaces/) |
| understand how AML provider adapters are structured          | [Provider engineering](../provider-authoring/)                                                   |
...
- [Agent providers](../providers/agents/) use ACP for the built-in coding-agent integrations.
- [Sandbox providers](../providers/sandboxes/) differ in read-only behavior, transfer semantics, cancellation, and deployment-owned security posture.
- [Workspace providers](../providers/workspaces/) differ in direct materialization versus revision-backed persistence.
...
- [AML evaluation model](../concepts/)
- [Runtime limits and errors](../runtime/)
