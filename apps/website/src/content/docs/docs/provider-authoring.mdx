...
The image name and output budget belong to `dockerSandbox()`. They do not become generic `<Sandbox />` props because Daytona, Modal, Local, and future providers do not share one honest configuration surface.
