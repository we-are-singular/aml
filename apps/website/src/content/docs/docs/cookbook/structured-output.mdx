...
Turn an Agent response into a typed finding instead of passing unvalidated prose between workflow stages. This recipe follows the maintained [`structured.tsx`](https://github.com/we-are-singular/aml/blob/main/examples/src/core/structured.tsx) example.
...
- [`AmlModelSchema`](https://github.com/we-are-singular/aml/blob/main/sdk/src/components/agent/aml-model-schema.ts)
