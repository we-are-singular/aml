...
- [`<Workspace />`](https://github.com/we-are-singular/aml/blob/main/sdk/src/components/workspace/workspace.tsx)
- [`<File />`](https://github.com/we-are-singular/aml/blob/main/sdk/src/components/file/file.tsx)
- [`<Sandbox />`](https://github.com/we-are-singular/aml/blob/main/sdk/src/components/sandbox/sandbox.tsx)
