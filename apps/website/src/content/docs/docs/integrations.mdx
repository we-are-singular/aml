...
In a real application supply the providers through the runtime or explicit props. [`<File />`](/docs/reference/primitives/file/) is shown at the [`<Workspace />`](/docs/reference/primitives/workspace/) boundary because it persists text through the Workspace provider; use [`<Agent />`](/docs/reference/primitives/agent/) or [`<Script />`](/docs/reference/primitives/script/) inside [`<Sandbox />`](/docs/reference/primitives/sandbox/) for process writes.
