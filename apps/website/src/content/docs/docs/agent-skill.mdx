...
2. **Choose explicit providers.** Separate the [Agent, Sandbox, and Workspace responsibilities](/docs/providers/) and check each provider’s prerequisites.
...
4. **Review authority and lifecycle.** Treat [Sandbox isolation](/docs/production/security/), credentials, Workspace publication, cancellation, and cleanup as explicit application decisions.
