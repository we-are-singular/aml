...
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`<Agent />`](/docs/reference/primitives/agent/)         | A model or coding-harness session, its turns, model configuration, and provider response.                            | Process isolation, durable files, or application-wide scheduling.    | [Codex](/docs/providers/agents/codex/), [GitHub Copilot](/docs/providers/agents/copilot/), [GLM](/docs/providers/agents/glm/), [OpenCode](/docs/providers/agents/opencode/), [Pi](/docs/providers/agents/pi/) |
