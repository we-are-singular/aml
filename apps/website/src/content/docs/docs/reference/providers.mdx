...
| -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`<Agent />`](/docs/reference/primitives/agent/)         | A model or coding-harness session, its turns, model configuration, and provider response.                            | Process isolation, durable files, or application-wide scheduling.    | [Codex](/docs/providers/agents/codex/), [OpenCode](/docs/providers/agents/opencode/), [Pi](/docs/providers/agents/pi/)                                                           |
...
5. Make release and repeated process cleanup safe when possible.
