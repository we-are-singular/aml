...
Use [`<Skill />`](/docs/reference/primitives/skill/) for reusable instruction files and [`<FollowUp />`](/docs/reference/primitives/follow-up/) for later user turns in the same session.
