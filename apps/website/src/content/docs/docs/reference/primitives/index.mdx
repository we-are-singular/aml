...
| Execute a command             | [`<Sandbox />`](/docs/reference/primitives/sandbox/)      | [`<Script />`](/docs/reference/primitives/script/) or a Sandbox-compatible [`<Agent />`](/docs/reference/primitives/agent/)                                                                                                                                 |
