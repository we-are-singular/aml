 ...
 */
type ObjectStateSchema = StandardSchemaV1<
  unknown,
...
type SelfNormalizingSchema<Schema extends ObjectStateSchema> =
  StandardSchemaV1.InferOutput<Schema> extends
...
export interface LoopProps<
  Schema extends ObjectStateSchema,
> {
  readonly initial: StandardSchemaV1.InferInput<Schema>
  readonly name?: string
  readonly render: (
    context: LoopRenderContext<
